...
public class MovablePointTest {
    @Test
    public void test_MovablePoint() {

        var p = new MovablePoint(1, 2, 10, 20);
    ...
    public void test_moveUp() {
        var p = new MovablePoint(10, 40, 10, 20);
        p.moveUp();
    ...
    public void test_moveLeft() {
        var p = new MovablePoint(40, 40, 10, 20);
        p.moveLeft();
    ...
    public void test_toString() {
        var p = new MovablePoint(40, 50, 10, 20);
